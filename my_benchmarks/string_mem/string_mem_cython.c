...
{
    "distutils": {
        "name": "string_mem_cython",
        "sources": [
            "string_mem_cython.pyx"
        ]
    },
    "module_name": "string_mem_cython"
}
END: Cython Metadata */
...
#define __PYX_HAVE__string_mem_cython
#define __PYX_HAVE_API__string_mem_cython
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "string_mem_cython" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "string_mem_cython"
extern int __pyx_module_is_main_string_mem_cython;
int __pyx_module_is_main_string_mem_cython = 0;

/* Implementation of "string_mem_cython" */
...
static const char __pyx_k_string_mem_cython[] = "string_mem_cython";
static const char __pyx_k_asyncio_coroutines[] = "asyncio.coroutines";
static const char __pyx_k_cline_in_traceback[] = "cline_in_traceback";
static const char __pyx_k_string_mem_cython_pyx[] = "string_mem_cython.pyx";
static const char __pyx_k_q_D_a_U_3aq_uAQ_axvT_2Q_1[] = "\200\001\330\004\027\220q\360\006\000\005\r\210D\220\006\220a\330\004\010\210\005\210U\220!\2203\220a\220q\330\010\017\210u\220A\220Q\330\010\016\210a\210x\220v\230T\240\021\240&\250\003\2502\250Q\330\004\013\2101";
static const char __pyx_k_Note_that_Cython_is_deliberately[] = "Note that Cython is deliberately stricter than PEP-484 and rejects subclasses of builtin types. If you need to pass subclasses then set the 'annotation_typing' directive to False.";
/* #### Code section: decls ### */
static PyObject *__pyx_pf_17string_mem_cython_word_count(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_text); /* proto */
...
#define __pyx_n_u_get __pyx_string_tab[7]
...
#define __pyx_n_u_string_mem_cython __pyx_string_tab[17]
#define __pyx_kp_u_string_mem_cython_pyx __pyx_string_tab[18]
#define __pyx_n_u_test __pyx_string_tab[19]
#define __pyx_n_u_text __pyx_string_tab[20]
#define __pyx_n_u_word __pyx_string_tab[21]
#define __pyx_n_u_word_count __pyx_string_tab[22]
...
/* Python wrapper */
static PyObject *__pyx_pw_17string_mem_cython_1word_count(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
...
static PyMethodDef __pyx_mdef_17string_mem_cython_1word_count = {"word_count", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_17string_mem_cython_1word_count, __Pyx_METH_FASTCALL|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_17string_mem_cython_1word_count(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "word_count", 0) < 0) __PYX_ERR(0, 1, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 1; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("word_count", 1, 1, 1, i); __PYX_ERR(0, 1, __pyx_L3_error) }
      }
  ...
  __Pyx_RaiseArgtupleInvalid("word_count", 1, 1, 1, __pyx_nargs); __PYX_ERR(0, 1, __pyx_L3_error)
  __pyx_L6_skip:;
  ...
  __Pyx_AddTraceback("string_mem_cython.word_count", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_text), (&PyUnicode_Type), 1, "text", 1))) __PYX_ERR(0, 1, __pyx_L1_error)
  __pyx_r = __pyx_pf_17string_mem_cython_word_count(__pyx_self, __pyx_v_text);
...
static PyObject *__pyx_pf_17string_mem_cython_word_count(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_text) {
...
*/
  ...
  __pyx_t_1 = PyUnicode_Split(__pyx_v_text, ((PyObject *)NULL), -1L); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 5, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_v_words = ((PyObject*)__pyx_t_1);
  __pyx_t_1 = 0;

  /* "string_mem_cython.pyx":6
 *     cdef int i
 *     words = text.split()
 *     for i in range(len(words)):             # <<<<<<<<<<<<<<
 *         word = words[i]
...
*/
  __pyx_t_2 = __Pyx_PyList_GET_SIZE(__pyx_v_words); if (unlikely(__pyx_t_2 == ((Py_ssize_t)-1))) __PYX_ERR(0, 6, __pyx_L1_error)
  __pyx_t_3 = __pyx_t_2;
  for (__pyx_t_4 = 0; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
    __pyx_v_i = __pyx_t_4;

    /* "string_mem_cython.pyx":7
 *     words = text.split()
 *     for i in range(len(words)):
 *         word = words[i]             # <<<<<<<<<<<<<<
 *         counts[word] = counts.get(word, 0) + 1
 *     return counts
*/
    __pyx_t_1 = __Pyx_GetItemInt_List(__pyx_v_words, __pyx_v_i, int, 1, __Pyx_PyLong_From_int, 1, 1, 1, 1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 7, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    ...
    /* "string_mem_cython.pyx":8
 *     for i in range(len(words)):
 *         word = words[i]
 *         counts[word] = counts.get(word, 0) + 1             # <<<<<<<<<<<<<<
 *     return counts
*/
    __pyx_t_1 = __Pyx_PyDict_GetItemDefault(__pyx_v_counts, __pyx_v_word, __pyx_mstate_global->__pyx_int_0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 8, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_5 = __Pyx_PyLong_AddObjC(__pyx_t_1, __pyx_mstate_global->__pyx_int_1, 1, 0, 0); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 8, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    if (unlikely((PyDict_SetItem(__pyx_v_counts, __pyx_v_word, __pyx_t_5) < 0))) __PYX_ERR(0, 8, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  }

  /* "string_mem_cython.pyx":9
 *         word = words[i]
 *         counts[word] = counts.get(word, 0) + 1
 *     return counts             # <<<<<<<<<<<<<<
*/
...
static int __pyx_pymod_exec_string_mem_cython(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_string_mem_cython},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
__Pyx_PyMODINIT_FUNC PyInit_string_mem_cython(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_string_mem_cython(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_string_mem_cython(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'string_mem_cython' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "string_mem_cython" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_string_mem_cython", 0);
  ...
  if (__pyx_module_is_main_string_mem_cython) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "string_mem_cython")) {
      if (unlikely((PyDict_SetItemString(modules, "string_mem_cython", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
 ...
 *     cdef str word
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_17string_mem_cython_1word_count, 0, __pyx_mstate_global->__pyx_n_u_word_count, NULL, __pyx_mstate_global->__pyx_n_u_string_mem_cython, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_word_count, __pyx_t_2) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init string_mem_cython", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init string_mem_cython");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static const __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {__pyx_k_string_mem_cython, sizeof(__pyx_k_string_mem_cython), 0, 1, 1}, /* PyObject cname: __pyx_n_u_string_mem_cython */
  {__pyx_k_string_mem_cython_pyx, sizeof(__pyx_k_string_mem_cython_pyx), 0, 1, 0}, /* PyObject cname: __pyx_kp_u_string_mem_cython_pyx */
...
static int __Pyx_CreateCodeObjects(__pyx_mstatetype *__pyx_mstate) {
  ...
  {
    const __Pyx_PyCode_New_function_description descr = {1, 0, 0, 5, (unsigned int)(CO_OPTIMIZED|CO_NEWLOCALS), 1, 68};
    PyObject* const varnames[] = {__pyx_mstate->__pyx_n_u_text, __pyx_mstate->__pyx_n_u_counts, __pyx_mstate->__pyx_n_u_word, __pyx_mstate->__pyx_n_u_i, __pyx_mstate->__pyx_n_u_words};
    __pyx_mstate_global->__pyx_codeobj_tab[0] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_string_mem_cython_pyx, __pyx_mstate->__pyx_n_u_word_count, __pyx_k_q_D_a_U_3aq_uAQ_axvT_2Q_1, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[0])) goto bad;
  }
